...
import static com.krista.spring.boot.base.ProjectConstant.*;
...
public class CodeGenerator {
    ...
    public static void genModelAndMapper(String tableName, String modelName) {
        ...
        sqlMapGeneratorConfiguration.setTargetPackage("mapper" + ProjectConstant.BUSINESS_PACKAGE);
    ...
    public static void genService(String tableName, String modelName) {
        try {
            ...
            data.put("businessPackage", ProjectConstant.BUSINESS_PACKAGE);
